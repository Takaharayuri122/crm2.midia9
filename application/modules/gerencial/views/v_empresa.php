<div class="page-content hidden" ng-controller="Empresa">
				...
				<div class="card-block">
					...
					<div class="col-lg-12">
						<fieldset class="form-group">
							...
							<button type="button" ng-click="adicionar()" class="btn btn-inline btn-primary btn-block">Adicionar Empresa</button>
						</fieldset>
					</div>
					<!-- <div class="col-lg-2">
						<fieldset class="form-group">
	...
	<script type="text/ng-template" id="v_AdicionarEmpresa">
			<section class="card">
				<header class="card-header">
					Adicionar Empresa
					<button ng-click="request()" type="button" class="modal-close">
						...
						<div class="row">
							<div class="col-lg-12">
								<fieldset class="form-group">
									...
									<select class="select2" ng-model="opt.tipo" ng-required="true" data-width="100%" ng-required="true">
							...
							<div class="col-lg-12" ng-if="opt.tipo == 2">
								<fieldset class="form-group">
									<label class="form-label semibold">Grupos</label>
									<select selectpicker class="select2" ng-model="detalhes.EMP_CodigoPai" data-width="100%" ng-required="true">
							...
							<div class="col-lg-12">
								<fieldset class="form-group">
									<label class="form-label" ng-show="opt.tipo != 1">Razão Social</label>
									<label class="form-label" ng-show="opt.tipo == 1">Nome do Grupo</label>
									<input type="text" ng-model="detalhes.EMP_RazaoSocial" class="form-control" ng-required="true"> 
								</fieldset>
							</div>
							<div class="col-lg-12">
								<fieldset class="form-group">
									<label class="form-label">CNPJ</label>
									<input type="text" ng-model="detalhes.EMP_CNPJ" mask="99.999.999/9999-99" class="form-control" ng-required="true">
								</fieldset>
							</div>
							<div class="col-lg-12">
								<fieldset class="form-group">
									<label class="form-label">Emails Gerentes</label>
									<textarea id="tags-editor-textarea" ng-model="detalhes.EMP_Email"></textarea>
								</fieldset>
							</div>
						</div>
					</form>
