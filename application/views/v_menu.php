<nav class="side-menu">
	    <ul class="side-menu-list">
	       ...
	       <li class="purple with-sub">
	            ...
	            <ul>
	            		<li><a href="<?=base_url('gerencial/empresa')?>"><span class="lbl">Empresas</span></a></li>
	            		<li><a href="<?=base_url('gerencial/usuario')?>"><span class="lbl">Usuários</span></a></li>
	            		<li><a href="dashboard-top-menu.html"><span class="lbl">Produtos</span></a></li>
	        ...
	        <li class="green with-sub">
	            ...
	            <ul>
	            		<li><a href="<?=base_url('Marketing/lead')?>"><span class="lbl">Leads</span></a></li>
	            		<li><a href="<?=base_url('gerencial/usuario')?>"><span class="lbl">Contatos</span></a></li>
	                <!-- <li><a href="index-2.html"><span class="lbl">Default</span><span class="label label-custom label-pill label-danger">new</span></a></li> -->
	            </ul>
	        </li>
	        ...
	        <li class="blue with-sub">
	            <span>
	                ...
	                <span class="lbl">Agenda de Eventos</span>
	            </span>
	            <ul>
	            		<li><a href="<?=base_url('Marketing/lead')?>"><span class="lbl">Contagem de Leads</span></a></li>
	                <!-- <li><a href="index-2.html"><span class="lbl">Default</span><span class="label label-custom label-pill label-danger">new</span></a></li> -->
	            </ul>
	        </li>
